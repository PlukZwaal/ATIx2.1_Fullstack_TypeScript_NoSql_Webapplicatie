  ...
  <div class="min-h-screen py-8 px-6">
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="lg:col-span-1">
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 p-6 sticky top-24">
      ...
      <div class="lg:col-span-3">
        ...
        <div v-else class="space-y-6">
          <div 
            ...
            class="group bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-6 cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-[1.02] relative overflow-hidden"
          >
            <!-- Gradient overlay -->
              ...
              <div class="flex justify-between items-start mb-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="relative">
                    ...
                    <!-- Dropdown menu -->
                    <div v-if="showMenus[module.id]" class="absolute right-0 top-12 bg-white border border-slate-200 rounded-xl shadow-lg z-20 min-w-40 overflow-hidden">
                      <button 
